# OPTIONAL: Use this as a template for changing philia configuration
# put it in your config/initializers directory
# values shown below are the defaults in philia
Philia.setup do |config|
...
# false if you do not
# In certain situations, philia will notify airbrake of a situation which
